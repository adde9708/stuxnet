...
typedef SIZE_T(WINAPI *_tVirtualQuery)(LPCVOID, PMEMORY_BASIC_INFORMATION,
                                       SIZE_T);
...
typedef NTSTATUS(WINAPI *_tZwCreateSection)(PHANDLE, ACCESS_MASK,
                                            POBJECT_ATTRIBUTES, PLARGE_INTEGER,
                                            ULONG, ULONG, HANDLE);
typedef NTSTATUS(WINAPI *_tZwMapViewOfSection)(HANDLE, HANDLE, PVOID *,
                                               ULONG_PTR, SIZE_T,
                                               PLARGE_INTEGER, PSIZE_T,
                                               SECTION_INHERIT, ULONG, ULONG);
typedef HANDLE(WINAPI *_tCreateThread)(LPSECURITY_ATTRIBUTES, SIZE_T,
